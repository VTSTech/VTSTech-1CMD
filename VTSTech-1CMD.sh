...
then
	...
	nmap1="proxychains -q nmap --proxies http://127.0.0.1:8118/ -n --dns-servers $ns -Pn --open -T3 --scan-delay 1 -p 21,22,23,25,80,110,143,443,445,993,995,1080,3128,3306,3389,5900,8080 -sV --script-args http.useragent=$ua -oN $HOME/Scans/nmap1-$target.txt $target"

	nmap2="proxychains -q nmap --proxies http://127.0.0.1:8118/ -n --dns-servers $ns -Pn --open -T3 --scan-delay 1 -top-ports 50 -sV  --script-args http.useragent=$ua -oN $HOME/Scans/nmap2-$target.txt $target"

	nmap3="sudo proxychains --proxies http://127.0.0.1:8118/ -q nmap -n --dns-servers $ns -Pn --open -T3 --scan-delay 1 --top-ports 100 -sV -O --script-args http.useragent=$ua -oN $HOME/Scans/nmap3-$target.txt $target"

	nmap4="sudo proxychains --proxies http://127.0.0.1:8118/ -q nmap -n --dns-servers $ns -Pn --open -T3 --scan-delay 1 --top-ports 250 -sV -O -A -oN $HOME/Scans/nmap4-$target.txt --script default --script-args http.useragent=$ua- $target"

	nmap5="sudo proxychains --proxies http://127.0.0.1:8118/ -q nmap -n --dns-servers $ns -Pn --open -T3 --scan-delay 1 --top-ports 500 -sV -O -A -oN $HOME/Scans/nmap5-$target.txt --script=discovery,vuln --script-args http.useragent=$ua $target"
	...
	nmap2="nmap --dns-servers $ns -Pn --open -T3 --top-ports 50 -sSV--script-args http.useragent=$ua -oN $HOME/Scans/nmap2-$target.txt --scan-delay 1 $target"

	nmap3="sudo nmap --dns-servers $ns -Pn --open -T3 --top-ports 100 -sSV -O --script-args http.useragent=$ua -oN $HOME/Scans/nmap3-$target.txt --scan-delay 1 $target"

	nmap4="sudo nmap --dns-servers $ns -Pn --open -T3 -p 21,22,23,25,80,110,143,443,445,993,995,1080,3128,3306,3389,5900,8080  -sSV -O -A -oN $HOME/Scans/nmap4-$target.txt -sC --script-args http.useragent=$ua --scan-delay 1  $target"

	nmap5="sudo nmap --dns-servers $ns -Pn --open -T3 --top-ports 500 -sSUV -O -A -oN $HOME/Scans/nmap5-$target.txt --script=discovery,vuln --script-args http.useragent=$ua --scan-delay 1 $target"
